...
At the start of every new chat, project session, or repo session, re-read the latest version of this skill before applying the workflow.

If the user says this workflow was updated, refresh the installed skill or re-read the latest repo before continuing.
...
- `references/PROMPT_OPTIMIZER.md` for full workflow rules
- `references/CONTEXT_QUESTIONS.md` for task-specific context questions
- `references/EXAMPLES.md` for examples of optimized prompts
